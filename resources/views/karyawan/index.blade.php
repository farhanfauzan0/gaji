                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content ">
                        <div class="modal-header bg-info ">
                            <h4 class="modal-title text-white" id="Modallabel3dsign">Tambah Data Karyawan</h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{ route('karyawan.store') }}" id="" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control form-control-md" id="jenis_kelamin"
                                                    name="jenis_kelamin">
                                        ...
                                        <div class="form-group">
                                            <label for="email" class="col-form-label"> Jabaran</label>
                                            <div class="input-group">
                                                <span class="input-group-addon input_email"><i
                                                        class="fa fa-bars text-primary"></i></span>
                                                <select class="form-control form-control-md" id="jabatan" name="jabatan">
                                                    <option selected disabled>-- Pilih Jabatan --</option>
                                                    @foreach ($datajabatan as $datajabatans)
                                                        <option value="{{ $datajabatans->id }}">
